...
var initAbout = function initAbout() {
  ...
  var text = document.querySelector('.about__additional-text');
  var span = document.querySelector('.about__text').querySelector('span');
...
var initAccordeon = function initAccordeon() {
  var headingContainers = document.querySelectorAll('.main-footer__heading-container');
  var sectionsLists = document.querySelector('.main-footer__sections-wrapper').querySelectorAll('ul');
  var contactsLists = document.querySelector('.main-footer__contacts-wrapper').querySelectorAll('ul');
  var footerButtons = [];
