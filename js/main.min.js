...
var initAbout = function initAbout() {
  ...
  var text = document.querySelector('[data-additional-text]');
  var span = document.querySelector('[data-about-text]').querySelector('span');
...
var initAccordeon = function initAccordeon() {
  var headingContainers = document.querySelectorAll('[data-heading-container]');
  var sectionsLists = document.querySelector('[data-sections-wrapper]').querySelectorAll('ul');
  var contactsLists = document.querySelector('[data-contacts-wrapper]').querySelectorAll('ul');
  var footerButtons = [];
  var footerListsArrays = [];
  if (sectionsLists) {
  ...
  if (footerButtons) {
    footerButtons.forEach(function (button, i) {
      button.addEventListener('click', function (evt) {
        button.classList.toggle('main-footer__button-js');
        var lists = footerListsArrays[i];
        ...
        if (evt.target.classList.contains('main-footer__button-sections')) {
          ...
          contactsLists.forEach(function (list) {
            list.classList.add('main-footer__list-js');
          });
          ...
          sectionsLists.forEach(function (list) {
            list.classList.add('main-footer__list-js');
          });
...
var fixHeader = function fixHeader() {
  var header = document.querySelector('[data-main-header]');
...
var initMask = function initMask() {
  var telInputs = document.querySelectorAll('input[data-user-tel]');
  var telMasks = [];
  var maskOptions = {
  ...
  if (telInputs) {
    for (var i = 0; i < telInputs.length; i++) {
      telMasks[i] = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](telInputs[i], maskOptions);
    }
  }
};
...
/* harmony import */ var _accordeon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./accordeon */ "./js/accordeon.js");
/* harmony import */ var _fix_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fix-header */ "./js/fix-header.js");
/* harmony import */ var _about__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./about */ "./js/about.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form */ "./js/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_fix_header__WEBPACK_IMPORTED_MODULE_3__["fixHeader"])();
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_about__WEBPACK_IMPORTED_MODULE_4__["initAbout"])();
    Object(_accordeon__WEBPACK_IMPORTED_MODULE_2__["initAccordeon"])();
    Object(_form__WEBPACK_IMPORTED_MODULE_5__["initMask"])();
  });
});
